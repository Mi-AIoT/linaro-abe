...
OPTIONS
  ...
  --ci-project <CI project>
                ...
                Which CI project this build is part of. Used to find known
                flaky tests.

  --ci-config <CI configuration>

                Which CI configuration this build is part of. Used to find
                known flaky tests.
...
while test $# -gt 0; do
	...
	--check)
	    ...
	    ;;
	--ci-project)
	    check_directive ci-project "$2"
	    ci_project="$2"
	    shift
	    ;;
	--ci-config)
	    check_directive ci-config "$2"
	    ci_config="$2"
	    shift
	    ;;
