...
#    trace "$*"
	...
	gcc)
		...
		# configure_build() we may not know
		...
		# the tests (with $ABE_TARGET_BOARD_OPTIONS, but
		# skipping the build part, so too late for an update
		# to gcc/VERSION to be taken into account).
